...
import isen.study.service.vcard.exceptions.NotDoneRecordingException;
import isen.study.service.view.Error;
...
public class StatsOverviewController implements EventHandler<ActionEvent> {
	...
	@FXML
	private void initialize() throws DBServiceConnectionException, NotDoneRecordingException {
